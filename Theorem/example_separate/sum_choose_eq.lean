...
-- theorem sum_choose_eq_from_0_to_0(n : ℕ)(gol:  Nat.choose (2 * n) y = Nat.choose (2 * n) (2 * n - y)) :
--    ∑ k in Ico 0 n, Nat.choose (2 * n) k = ∑ k in Ico 0 n, Nat.choose (2 * n) (2 * n - k) := by
--   refine' sum_congr rfl fun y hy ↦ _
--   apply gol

-- theorem sum_choose_eq_from_0_to_1(n : ℕ)(gol:  Nat.choose (2 * n) y = Nat.choose (2 * n) (2 * n - y)) :
--    ∑ k in Ico 0 n, Nat.choose (2 * n) k = ∑ k in Ico 0 n, Nat.choose (2 * n) (2 * n - k) := by
--   refine' sum_congr rfl fun y hy ↦ _
--   have yn : y < n := by exact (mem_Ico.1 hy).2
--   apply gol

-- theorem sum_choose_eq_from_0_to_2(n : ℕ)(gol:  Nat.choose (2 * n) y = Nat.choose (2 * n) (2 * n - y)) :
--    ∑ k in Ico 0 n, Nat.choose (2 * n) k = ∑ k in Ico 0 n, Nat.choose (2 * n) (2 * n - k) := by
--   refine' sum_congr rfl fun y hy ↦ _
--   have yn : y < n := by exact (mem_Ico.1 hy).2
--   have y2n : y ≤ 2 * n := by linarith
...
theorem sum_choose_eq_from_0_to_3(n : ℕ) :
   ∑ k in Ico 0 n, Nat.choose (2 * n) k = ∑ k in Ico 0 n, Nat.choose (2 * n) (2 * n - k) := by
  refine' sum_congr rfl fun y hy ↦ _
  have yn : y < n := by exact (mem_Ico.1 hy).2
  have y2n : y ≤ 2 * n := by linarith
