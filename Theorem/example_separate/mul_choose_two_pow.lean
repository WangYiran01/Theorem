...
theorem mul_choose_two_pow_from_0_to_0(n : ℕ)(hn : 0 < n)(gol:  ∑ l in range n, Nat.choose (n - 1) l = 2 ^ (n - 1)) :
   n * ∑ l in range n, Nat.choose (n - 1) l = n * 2 ^ (n - 1) := by
  congr 1
  -- apply gol

theorem mul_choose_two_pow_from_0_to_1(n : ℕ)(hn : 0 < n)(gol:  ∑ l in range n, Nat.choose (n - 1) l = 2 ^ (n - 1)) :
   n * ∑ l in range n, Nat.choose (n - 1) l = n * 2 ^ (n - 1) := by
  congr 1
  -- have n1 : 1 ≤ n := by linarith
  -- apply gol

theorem mul_choose_two_pow_from_0_to_2(n : ℕ)(hn : 0 < n)(gol:  ∑ l in range n, Nat.choose (n - 1) l = 2 ^ (n - 1)) :
   n * ∑ l in range n, Nat.choose (n - 1) l = n * 2 ^ (n - 1) := by
  congr 1
  -- have n1 : 1 ≤ n := by linarith
  -- have hn1 : ∑ l in range n, choose (n-1) l = ∑ l in range (n - 1 + 1), choose (n-1) l   := by
...
theorem mul_choose_two_pow_from_0_to_3(n : ℕ)(hn : 0 < n)(gol:  ∑ l in range (n - 1 + 1), Nat.choose (n - 1) l = 2 ^ (n - 1)) :
   n * ∑ l in range n, Nat.choose (n - 1) l = n * 2 ^ (n - 1) := by
  congr 1
  have n1 : 1 ≤ n := by linarith
  have hn1 : ∑ l in range n, choose (n-1) l = ∑ l in range (n - 1 + 1), choose (n-1) l   := by
...
theorem mul_choose_two_pow_from_0_to_4(n : ℕ)(hn : 0 < n) :
   n * ∑ l in range n, Nat.choose (n - 1) l = n * 2 ^ (n - 1) := by
  congr 1
  have n1 : 1 ≤ n := by linarith
  have hn1 : ∑ l in range n, choose (n-1) l = ∑ l in range (n - 1 + 1), choose (n-1) l   := by
