...
theorem sum_choose_eq_pow_add'_from_0_to_0(n : ℕ)(h : 1 ≤ n)(gol:  ↑(∑ k in range (n + 1), Nat.choose (2 * n) k) = 2 ^ (2 * n - 1) + 1 / 2 * ↑(Nat.choose (2 * n) n)) :
...
theorem sum_choose_eq_pow_add'_from_0_to_1(n : ℕ)(h : 1 ≤ n)(gol:  ↑(∑ k in range (n + 1), Nat.choose (2 * n) k) = 2 ^ (2 * n - 1) + 1 / 2 * ↑(Nat.choose (2 * n) n)) :
   ↑(∑ k in range (n + 1), Nat.choose (2 * n) k) = 2 ^ (2 * n - 1) + 1 / 2 * ↑(Nat.choose (2 * n) n) := by
  have h1 : ∑ k in range (n+1), choose (2*n) k + ∑ k in Ico (n+1) (2*n+1), choose (2*n) k = ((2^(2*n)) : ℝ) := by
    rw [←cast_add]
    rw [sum_range_add_sum_Ico, sum_range_choose (2*n), cast_pow]
...
theorem sum_choose_eq_pow_add'_from_0_to_2(n : ℕ)(h : 1 ≤ n)(gol:  ↑(∑ k in range (n + 1), Nat.choose (2 * n) k) = 2 ^ (2 * n - 1) + 1 / 2 * ↑(Nat.choose (2 * n) n)) :
   ↑(∑ k in range (n + 1), Nat.choose (2 * n) k) = 2 ^ (2 * n - 1) + 1 / 2 * ↑(Nat.choose (2 * n) n) := by
  have h1 : ∑ k in range (n+1), choose (2*n) k + ∑ k in Ico (n+1) (2*n+1), choose (2*n) k = ((2^(2*n)) : ℝ) := by
    rw [←cast_add]
    rw [sum_range_add_sum_Ico, sum_range_choose (2*n), cast_pow]
...
theorem sum_choose_eq_pow_add'_from_0_to_3(n : ℕ)(h : 1 ≤ n)(gol:  ↑(∑ k in range (n + 1), Nat.choose (2 * n) k) = 2 ^ (2 * n - 1) + 1 / 2 * ↑(Nat.choose (2 * n) n)) :
   ↑(∑ k in range (n + 1), Nat.choose (2 * n) k) = 2 ^ (2 * n - 1) + 1 / 2 * ↑(Nat.choose (2 * n) n) := by
  have h1 : ∑ k in range (n+1), choose (2*n) k + ∑ k in Ico (n+1) (2*n+1), choose (2*n) k = ((2^(2*n)) : ℝ) := by
    rw [←cast_add]
    rw [sum_range_add_sum_Ico, sum_range_choose (2*n), cast_pow]
...
theorem sum_choose_eq_pow_add'_from_1_to_2(n : ℕ)(h : 1 ≤ n)(h1 :  ↑(∑ k in range (n + 1), Nat.choose (2 * n) k) + ↑(∑ k in Ico (n + 1) (2 * n + 1), Nat.choose (2 * n) k) = 2 ^ (2 * n))(gol:  ↑(∑ k in range (n + 1), Nat.choose (2 * n) k) = 2 ^ (2 * n - 1) + 1 / 2 * ↑(Nat.choose (2 * n) n)) :
   ↑(∑ k in range (n + 1), Nat.choose (2 * n) k) = 2 ^ (2 * n - 1) + 1 / 2 * ↑(Nat.choose (2 * n) n) := by
  have : 0 ≤ n := by exact Nat.zero_le n
  have h3 : ∑ x in range n, Nat.choose (2 * n) (n + 1 + x)
            = ∑ x in range n, Nat.choose (2 * n) (n - 1 - x) := by
...
theorem sum_choose_eq_pow_add'_from_1_to_3(n : ℕ)(h : 1 ≤ n)(h1 :  ↑(∑ k in range (n + 1), Nat.choose (2 * n) k) + ↑(∑ k in Ico (n + 1) (2 * n + 1), Nat.choose (2 * n) k) = 2 ^ (2 * n))(gol:  ↑(∑ k in range (n + 1), Nat.choose (2 * n) k) = 2 ^ (2 * n - 1) + 1 / 2 * ↑(Nat.choose (2 * n) n)) :
   ↑(∑ k in range (n + 1), Nat.choose (2 * n) k) = 2 ^ (2 * n - 1) + 1 / 2 * ↑(Nat.choose (2 * n) n) := by
  have : 0 ≤ n := by exact Nat.zero_le n
  have h3 : ∑ x in range n, Nat.choose (2 * n) (n + 1 + x)
            = ∑ x in range n, Nat.choose (2 * n) (n - 1 - x) := by
...
theorem sum_choose_eq_pow_add'_from_2_to_2(n : ℕ)(h : 1 ≤ n)(h1 :  ↑(∑ k in range (n + 1), Nat.choose (2 * n) k) + ↑(∑ k in Ico (n + 1) (2 * n + 1), Nat.choose (2 * n) k) = 2 ^ (2 * n))(this : 0 ≤ n)(gol:  ↑(∑ k in range (n + 1), Nat.choose (2 * n) k) = 2 ^ (2 * n - 1) + 1 / 2 * ↑(Nat.choose (2 * n) n)) :
   ↑(∑ k in range (n + 1), Nat.choose (2 * n) k) = 2 ^ (2 * n - 1) + 1 / 2 * ↑(Nat.choose (2 * n) n) := by
  have h3 : ∑ x in range n, Nat.choose (2 * n) (n + 1 + x)
            = ∑ x in range n, Nat.choose (2 * n) (n - 1 - x) := by
      refine' sum_congr rfl fun k hk => _
...
theorem sum_choose_eq_pow_add'_from_2_to_3(n : ℕ)(h : 1 ≤ n)(h1 :  ↑(∑ k in range (n + 1), Nat.choose (2 * n) k) + ↑(∑ k in Ico (n + 1) (2 * n + 1), Nat.choose (2 * n) k) = 2 ^ (2 * n))(this : 0 ≤ n)(gol:  ↑(∑ k in range (n + 1), Nat.choose (2 * n) k) = 2 ^ (2 * n - 1) + 1 / 2 * ↑(Nat.choose (2 * n) n)) :
   ↑(∑ k in range (n + 1), Nat.choose (2 * n) k) = 2 ^ (2 * n - 1) + 1 / 2 * ↑(Nat.choose (2 * n) n) := by
  have h3 : ∑ x in range n, Nat.choose (2 * n) (n + 1 + x)
            = ∑ x in range n, Nat.choose (2 * n) (n - 1 - x) := by
      refine' sum_congr rfl fun k hk => _
